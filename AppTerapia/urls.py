...
from AppTerapia.views import listar_consultantes, listar_pacientes, listar_psicologos, pacientes, crear_consultante, crear_paciente, crear_psicologo, buscar_paciente
